# Functional Python [![](https://github.com/NACB/functional-python/workflows/tests/badge.svg)](https://github.com/NACB/functional-python/actions?query=workflow%3Atests)
